...
<?php
  ...
  ?>
        ...
        <nav class="navbar1" >
            ...
            <a href="#" class="nav_item" style="color: #fff;">about</a>
            <a href="#" class="nav_item" style="color: #fff;">menu</a>
            <a href="#" class="nav_item" style="color: #fff;">contact</a>
            <a href="index.php?q=enrol" class="nav_item" style="color: black;">Login</a>
