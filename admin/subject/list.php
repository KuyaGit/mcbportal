				  ...
				  <tbody>
				  	<?php  //`SUBJ_ID`, `SUBJ_CODE`, `SUBJ_DESCRIPTION`, `UNIT`, `PRE_REQUISITE`, `COURSE_ID`, `AY`, `SEMESTER`
						...
						foreach ($cur as $result) {
						  ...
						  <a title="Edit" href="index.php?view=edit&id='.$result->SUBJ_ID.'"  class="btn btn-primary btn-xs  ">  <span class="fa fa-edit fw-fa"></span></a>
						  <a title="Edit" href="index.php?view=view&id='.$result->SUBJ_ID.'"  class="btn btn-primary btn-xs "> <span class="fa fa-upload"></span></a>
