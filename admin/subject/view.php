...
?> 
 ...
 <form class="form-horizontal span6" action="controller.php?action=edit" method="POST">
      ...
      <div class="row">
         <div class="col-lg-12">
            <h1 class="page-header">Upload In Learning Materials</h1>
          </div>
    ...
    <form action="controller2.php?action=files" method="post" enctype="multipart/form-data">
      <input type="file" name="file">
      <input type="submit" name="save" value="Upload File">
  </form>

 
    <input type="text" class="form-control input-md" readonly value="<?php echo $res->module; ?>">
