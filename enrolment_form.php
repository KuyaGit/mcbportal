...
<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#New" data-toggle="tab">Register</a></li> 
    <li><a href="#Old" data-toggle="tab">Login in Portal</a></li>
     ...
     <div class="tab-pane" id="Old">
        ...
        <div class="panel panel-default">
          <div class="panel-body">
              <div class="well well-sm"  style="background-color:#010039;color:#fff;"><b >  Login </b> </div>
                  ...
                  <form class="form-horizontal span6" action="login.php" method="POST">
                      <div class="form-group">
                        ...
                        <div class="form-group">
                        <div class="col-md-12"> 
                          <button type="submit" id="oldLogin" name="oldLogin"  style="background-color:#010039;color:#fff;" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-logged-in "></span>   Login</button> 
